...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: {  title: @quest. title, description: @quest.description, image_url: @quest.image_url, points: @quest.points }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: {  title: @quest. title, description: @quest.description, image_url: @quest.image_url, points: @quest.points }
    assert_redirected_to quest_path(assigns(:quest))
  end
